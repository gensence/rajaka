...
<a href="http://www.sorbs.net/" target="_blank">SORBS</a>は、複数のSORBS DNSBLを扱います。 <br>SORBS DNSBLをフィルタリングシステムとして利用するメールサーバの管理者は、サーバの規模やブロックしたいメールの種別に則したSORBS DNSBLを採用します。
<br><br>
